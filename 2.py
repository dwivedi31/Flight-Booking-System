...
Label(fr2,text="JUET",font=("algerian",38),fg="Orange").pack()
Label(fr2,text="Yash Dwivedi",font=("Bauhaus 93",14),fg="Red").pack()
Label(fr2,text="161B277 ",font=("Bauhaus 93",14),fg="Red").pack()
Label(fr2,text="B-9",font=("Bauhaus 93",14),fg="Red").pack()
Label(fr2,text="dyash.3111997@gmail.com",font=("Bauhaus 93",14),fg="Red").pack()
def airline():
    root.destroy()
    root1=Tk()
    ...
    def signup():
                 ...
                 root=Tk()
                 root.title("Sign Up")
                 d=PhotoImage(file="airplane.gif")
